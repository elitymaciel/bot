...
class Util
{
    ...
    function palavras($palavra1, $palavra2, $porcentagem_minima = 80) {
        // Calcula a porcentagem de similaridade entre as duas palavras
        $porcentagem = 0;
        similar_text($palavra1, $palavra2, $porcentagem);
        
        // Verifica se a porcentagem é maior ou igual à porcentagem mínima
        return $porcentagem >= $porcentagem_minima;
    }
