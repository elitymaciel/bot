        ...
        function (e, t, n) {
            ...
            class i {
                    ...
                    if ((this.dispatch("click", e), "fixed" === this.editor_mode)) {
                        ...
                        "view" === this.editor_mode
                            ...
                            : ((this.first_click = e.target),
                                ...
                                0 === e.button && this.contextmenuDel() && this.contextmenuEdit(),
                ...
                contextmenu(e) {
                    ...
                    if ((this.precanvas.getElementsByClassName("drawflow-edit").length && this.precanvas.getElementsByClassName("drawflow-edit")[0].remove(), this.node_selected || this.connection_selected)) {
                        var editButton = document.createElement("div");
                        editButton.classList.add("drawflow-edit"),
                            (editButton.innerHTML = "🖌️"),
                            this.node_selected && this.node_selected.appendChild(editButton),
                            this.connection_selected &&
                            this.connection_selected.parentElement.classList.length > 1 &&
                            ((editButton.style.top =
                                ...
                                (editButton.style.left =
                                    ...
                                    this.precanvas.getBoundingClientRect().x * (this.precanvas.clientWidth / (this.precanvas.clientWidth * this.zoom)) +
                                    "px"),
                                this.precanvas.appendChild(editButton));
                    }
                }
                contextmenuDel() {
